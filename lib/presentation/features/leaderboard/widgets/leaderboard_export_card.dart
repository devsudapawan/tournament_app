...
class _LeaderboardExportRow extends StatelessWidget {
  ...
  Color get _rowColor {
    switch (position) {
      case 1:  return AppColors.rank1.withOpacity(0.08);
      case 2:  return AppColors.rank2.withOpacity(0.05);
      case 3:  return AppColors.rank3.withOpacity(0.05);
      default: return position.isEven ? AppColors.bg2 : AppColors.bg3;
    }
  }

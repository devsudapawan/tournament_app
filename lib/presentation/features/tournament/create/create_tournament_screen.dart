...
// //   @override
// //   void dispose() {
// //     _nameCtrl.dispose(); _orgCtrl.dispose();
// //     super.dispose();
// //   }
// //
// //   void _next() {
...
// //   void _back() {
// //     final step = ref.read(_stepProvider);
// //     if (step > 1) ref.read(_stepProvider.notifier).state = step - 1;
// //     else context.pop();
// //   }
// //
...
// //       (tournament) async {
// //         // 2. Save teams
// //         final teamEntities = teams.map((t) => TeamEntity(
// //           id:           const Uuid().v4(),
...
// //         if (mounted) {
// //           context.go(
// //             '${AppRoutes.tournamentDetail}/${tournament.id}',
// //           );
// //         }
// //       },
// //     );
...
// //                   const _Step3(),
// //                   const _Step4(),
// //                   _Step5(nameCtrl: _nameCtrl, orgCtrl: _orgCtrl,
// //                       onLaunch: _launch),
// //                 ][step - 1],
// //               ),
// //             ],
...
// //                 child: AppButton(
// //                   label: step == 4 ? 'Confirm & Continue' : 'Continue',
// //                   onTap: _next,
// //                 ),
// //               ),
// //             )
...
// //         ),
// //         const SizedBox(height: 8),
// //         _GameCard(name: 'PUBG Mobile', sub: 'Coming soon', isLocked: true),
// //         const SizedBox(height: 8),
// //         _GameCard(name: 'Free Fire',   sub: 'Coming soon', isLocked: true),
// //         const SizedBox(height: 24),
...
// //               crossAxisAlignment: CrossAxisAlignment.start,
// //               children: [
// //                 Text(name, style: AppTextStyles.subheading(color: AppColors.white)),
// //                 Text(sub,  style: AppTextStyles.body(color: AppColors.muted, size: 12)),
// //               ],
// //             ),
// //           ),
// //           if (isLocked)
...
// //                           if (n != null) {
// //                             ref.read(_rankPointsProvider.notifier).state =
// //                                 {...rankPts, pos: n};
// //                           }
// //                         },
// //                       ),
...
// //                     final updated = [...times];
// //                     updated[i] = full;
// //                     ref.read(_scheduledTimesProvider.notifier).state = updated;
// //                   }
// //                 }
// //               },
// //               child: Container(
...
// // class _Step4 extends ConsumerWidget {
// //   const _Step4();
// //
...
// //
// //     final newImages = [...images, File(picked.path)];
// //     ref.read(_teamImagesProvider.notifier).state = newImages;
// //
// //     // Run OCR
// //     final ocr = ref.read(ocrServiceProvider);
// //     final entries = await ocr.readTeamListImages(newImages);
...
// //         children: [
// //           const InfoBanner(
// //             'Upload the slot + team name image (PointCalc style card). Max 2 images. OCR extracts all team names automatically.',
// //           ),
// //           const SectionLabel('Upload Images (max 2)'),
// //
// //           // Upload box
// //           if (images.length < 2)
// //             GestureDetector(
...
// //             const SizedBox(height: 12),
// //             ...images.asMap().entries.map((e) => _FileChip(
// //               index: e.key,
// //               file:  e.value,
// //               onRemove: () {
// //                 final updated = [...images]..removeAt(e.key);
...
// //             ),
// //             const SizedBox(height: 12),
// //             ...ocrTeams.asMap().entries.map((e) =>
// //                 _OcrTeamRow(index: e.key, entry: e.value)),
// //           ],
// //         ],
// //       ),
// //     );
...
// //   const _FileChip({required this.index, required this.file, required this.onRemove});
// //
// //   @override
...
// //           child: Text('IMG', style: AppTextStyles.label(
...
// //                   isEdited:    true,
// //                 );
// //                 ref.read(_ocrTeamsProvider.notifier).state = teams;
// //               },
// //             ),
// //           ),
...
// //             child: Column(
// //               children: [
// //                 _SummaryRow('Name',       nameCtrl.text.isEmpty
// //                     ? '(not set)' : nameCtrl.text,
// //                     highlight: true),
// //                 _SummaryRow('Organizer',  orgCtrl.text.isEmpty
// //                     ? '(not set)' : orgCtrl.text),
// //                 _SummaryRow('Game',       'BGMI'),
// //                 _SummaryRow('Matches',    '$matchCount matches'),
// //                 _SummaryRow('Teams',      '${teams.length} registered'),
// //                 _SummaryRow('Win points', '${rankPts[1]} pts'),
// //                 _SummaryRow('Kill points','1 pt / kill', isLast: true),
// //               ],
// //             ),
// //           ),
// //           const SizedBox(height: 20),
// //           const SectionLabel('Team Preview'),
// //           ...teams.take(5).map((t) => Padding(
// //             padding: const EdgeInsets.only(bottom: 8),
// //             child: Container(
// //               padding: const EdgeInsets.symmetric(
// //                   horizontal: 14, vertical: 10),
...
// //             onTap: () => ref.read(_stepProvider.notifier).state = 1,
// //           ),
// //         ],
// //       ),
// //     );
...
// //       children: [
// //         Text(label, style: AppTextStyles.body(color: AppColors.muted, size: 13)),
// //         Text(value,
// //             style: AppTextStyles.subheading(
...
// lib/presentation/features/tournament/create/create_tournament_screen.dart
//
// KEY FIXES:
// 1. OCR regex now handles separate blocks (slot in yellow box,
//    name in black box) — the actual ML Kit output format
// 2. Step4 is now ConsumerStatefulWidget so OCR result survives rebuilds
// 3. Added loading overlay during OCR in Step 4
// 4. Teams show 0 → fixed by improved block-level OCR matching
// 5. Reset no longer clears ocrTeams prematurely
// ============================================================
